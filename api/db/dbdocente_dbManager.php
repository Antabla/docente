...
function getConnection() {
	...
	global $db_docente_db_Url, $db_docente_db_User, $db_docente_db_Pass, $db_docente_db_DbName;
	
	try {
		$dbh = new PDO("mysql:host=".$db_docente_db_Url.";dbname=".$db_docente_db_DbName, $db_docente_db_User, $db_docente_db_Pass);
