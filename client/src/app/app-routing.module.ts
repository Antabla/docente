...
import { PeriodoEditComponent} from './pages/periodo-edit/periodo-edit.component';
...
const routes: Routes = [
    ...
    { path: 'periodos/:id',  loadChildren: './pages/periodo-edit/periodo-edit.module#PeriodoEditModule' , canActivate: [AuthGuard] },
    { path: 'periodos',  loadChildren: './pages/periodo-list/periodo-list.module#PeriodoListModule' , canActivate: [AuthGuard] },
